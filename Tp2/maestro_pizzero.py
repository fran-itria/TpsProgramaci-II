...
class MaestroPizzero:
    def __init__(self, nom):
        ...
        self.pizzasPorEntregar = []  # Lista que almacenará las pizzas listas para entregar
    ...
    def tomarPedido(self, var):
        ...
        self.pizzasPorCocinar.append(nueva_pizza)  # Agregamos la pizza a la lista de pizzas por cocinar
    ...
    def cocinar(self):
        if self.pizzasPorCocinar:  # Verificamos si hay pizzas para cocinar
            self.pizzasPorEntregar.extend(self.pizzasPorCocinar)  # Movemos todas las pizzas a la lista de por entregar
    ...
    def entregar(self):
        pizzas_entregadas = self.pizzasPorEntregar[:2]  # Seleccionamos hasta 2 pizzas de la lista
        self.pizzasPorEntregar = self.pizzasPorEntregar[2:]  # Removemos las pizzas entregadas de la lista
