...
def prints(pizza1, pizza2, pizza3, pizza4, orden, numOrden):
    print('')
    print(f'Estado de la orden {numOrden}: {orden.obtenerEstadoOrden()}')
    print(f'Estado de la pizza 1: {pizza1.obtenerEstado()}')
    print(f'Estado de la pizza 2: {pizza2.obtenerEstado()}')
    print(f'Estado de la pizza 3: {pizza3.obtenerEstado()}')
    if pizza4:
        print(f'Estado de la pizza 4: {pizza4.obtenerEstado()}')
